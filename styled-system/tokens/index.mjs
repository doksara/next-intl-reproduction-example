const tokens = {
  ...
  "colors.magenta": {
    "value": "#FF407F",
    "variable": "var(--colors-magenta)"
  },
  "colors.magentaDark": {
    "value": "#E53972",
    "variable": "var(--colors-magenta-dark)"
  },
  "colors.blueAccent": {
    "value": "#D7DBFD",
    "variable": "var(--colors-blue-accent)"
  },
  "colors.blueLightest": {
    "value": "#AFB8FB",
    "variable": "var(--colors-blue-lightest)"
  },
  "colors.blueLight": {
    "value": "#768DFF",
    "variable": "var(--colors-blue-light)"
  },
  "colors.blue.50": {
    "value": "#eff6ff",
  ...
  "colors.blueDark": {
    "value": "#212A6D",
    "variable": "var(--colors-blue-dark)"
  },
  "colors.blueDarkest": {
    "value": "#191E3F",
    "variable": "var(--colors-blue-darkest)"
  },
  "colors.blueShades": {
    "value": "#28359A",
    "variable": "var(--colors-blue-shades)"
  },
  "colors.grey": {
    "value": "#121212",
