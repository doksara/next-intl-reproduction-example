...
export interface Conditions {
	...
	"md": string
	/** `@media screen and (min-width: 62rem) and (max-width: 83.9975rem)` */
	"mdOnly": string
	/** `@media screen and (max-width: 61.9975rem)` */
	"mdDown": string
	/** `@media screen and (min-width: 84rem)` */
	"lg": string
	/** `@media screen and (min-width: 84rem) and (max-width: 95.9975rem)` */
	"lgOnly": string
	/** `@media screen and (max-width: 83.9975rem)` */
	"lgDown": string
	/** `@media screen and (min-width: 96rem)` */
	"2xl": string
	/** `@media screen and (min-width: 96rem) and (max-width: 107.9975rem)` */
	"2xlOnly": string
	...
	/** `@media screen and (min-width: 108rem)` */
	"xlOnly": string
	/** `@media screen and (max-width: 107.9975rem)` */
	"xlDown": string
	/** `@media screen and (min-width: 48rem) and (max-width: 61.9975rem)` */
	"smToMd": string
	/** `@media screen and (min-width: 48rem) and (max-width: 83.9975rem)` */
	"smToLg": string
	/** `@media screen and (min-width: 48rem) and (max-width: 95.9975rem)` */
	"smTo2xl": string
	/** `@media screen and (min-width: 48rem) and (max-width: 107.9975rem)` */
	"smToXl": string
	/** `@media screen and (min-width: 62rem) and (max-width: 83.9975rem)` */
	"mdToLg": string
	/** `@media screen and (min-width: 62rem) and (max-width: 95.9975rem)` */
	"mdTo2xl": string
	/** `@media screen and (min-width: 62rem) and (max-width: 107.9975rem)` */
	"mdToXl": string
	/** `@media screen and (min-width: 84rem) and (max-width: 95.9975rem)` */
	"lgTo2xl": string
	/** `@media screen and (min-width: 84rem) and (max-width: 107.9975rem)` */
	"lgToXl": string
	/** `@media screen and (min-width: 96rem) and (max-width: 107.9975rem)` */
	"2xlToXl": string
