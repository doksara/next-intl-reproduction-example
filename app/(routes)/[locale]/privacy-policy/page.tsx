...
export const metadata: Metadata = {
  title: "Privacy policy | Sofascore Editor",
  metadataBase: new URL("https://editor.sofascore.com/privacy-policy"),
  alternates: {
    canonical: ".",
  },
}
...
export default function PrivacyPolicy({
  ...
  return (
    <main>
      <Section id="privacy-policy" background="grey" overflow="initial">
        <Container>
