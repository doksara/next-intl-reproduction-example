...
export const metadata: Metadata = {
  title: "Cookie Policy | Sofascore Editor",
  metadataBase: new URL("https://editor.sofascore.com/cookie-policy"),
  alternates: {
    canonical: ".",
  },
}
...
export default function CookiePolicy({
  ...
  return (
    <main>
      <Section id="cookies" background="grey" overflow="initial">
        <Container>
